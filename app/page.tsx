    ...
    <>
        ...
        <div className="bg-linear-to-r from-[#9e1b66] to-[#2c1b4e] text-white relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto grid md:grid-cols-2 min-h-[550px]">
            ...
            {/* Hero Content */}
            <div className="px-4 sm:px-6 lg:px-8 py-16 flex flex-col justify-center relative z-10">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 w-fit mb-6">
                ...
                <span className="text-[10px] uppercase tracking-wider font-medium text-white/80">Admissions Open 2026</span>
              </div>
